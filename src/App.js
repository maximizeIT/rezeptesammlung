...
function App(props) {
  ...
  const filterOptions = (data, { inputValue }) => matchSorter(data, inputValue, {keys: ['recipe_title', 'recipe_content'], threshold: matchSorter.rankings.CONTAINS});
  ...
  return (
    <Container maxWidth="lg">
      ...
      <HideOnScroll {...props}>
        <AppBar color={error ? "error" : "primary"} sx={{ height: openPopper ? '100%' : 'inherit' }}>
          <Toolbar>
              { !error ? 
                <Grid
                    container
                ...
                >
                    <Grid item xs={12} sm={12} md={3}>
                      <Box sx={{ py: 1 }}>
                        <Typography align={ triggerSm ? "left" : "center"} variant="h6" component="h6" sx={{ flexGrow: 1, ml: 1 }} onClick={handleIsRecipeSelectedDelete}>
                              Rezeptesammlung
                        </Typography>
                      </Box>
                    </Grid>

                    <Grid item xs={12} sm={9} md={6} container alignItems={"center"} onClick={onAutocompleteClick}>
                        ...
                        <ClickAwayListener onClickAway={handleClose}>
                            <Autocomplete
                                ...
                                isOptionEqualToValue={(option, value) => option.recipe_title === value.recipe_title}
                    ...
                    <Grid item xs={12} sm={3} md={3} container justifyContent={ triggerSm ? "right" : "center"} alignItems={ triggerSm ? "right" : "center"}>
                        <Stack
                            direction="row"
                        ...
                        >
                            ...
                            { !isRecipeSelected && 
                                <Box sx={{ py: 1, paddingTop: 1.5 }}>
                                    <Chip color='secondary' label={`${ allRecipes ? allRecipes.length : '0'} Rezepte`}/>
                                </Box>
                            }
                    ...
                    {loading ?
                        ...
                        <InfiniteScroll
                            ...
                            { view === 'masonry' ? 
                                ...
                                :
                                <List sx={{ width: '100%' }} subheader={<li style={{ background: "none" }} />}>
                                    { !isRecipeSelected || showAll ? 
                                        <Box>
